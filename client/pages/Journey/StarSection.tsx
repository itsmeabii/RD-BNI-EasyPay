...
export function StarSection({ filled = false, size = "lg", className = "" }: StarProps) {
  ...
  const { sizeClass, viewBox, path, strokeWidth } = config[size];
  ...
  return (
    ...
    >
      <path
        d={path}
        // Fill the star path directly — not a rect behind it
        fill={filled ? "#FFD900" : "none"}
        stroke={filled ? "#E6C200" : "#1E1E1E"}
