...
export default function ShoppingCartButton({ count = 0 }: ShoppingCartButtonProps) {
  return (
    <button className="fixed right-10 bottom-0 -translate-y-1/2 bg-bni-red text-white rounded-full p-3 lg:p-4 hover:opacity-90 transition-opacity shadow-lg flex items-center justify-center">
